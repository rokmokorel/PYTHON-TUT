...
I
show
here: https: // youtu.be / nwjAHQERL08?t = 37
m

2.
Download
Kivy
for Python 3 Kivy-1.9.1-osx-python3.7z here: https: // kivy.org /  # download
...
terminal: sudo
mv
Kivy2.app / Applications / Kivy.app

5.
In
terminal: ln - s / Applications / Kivy.app / Contents / Resources / script / usr / local / bin / kivy
...
# We can separate the logic from the presentation layer < Label >:
text: "Hello Kivy"